...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomerCustomerDemo>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithOne(p => p.CustomerCustomerDemo)
                .HasForeignKey<CustomerCustomerDemo>(d => d.CustomerId)
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasMany(d => d.Idpermisos).WithMany(p => p.Emails)
                .UsingEntity<Dictionary<string, object>>(
                    "PermisosByUsuario",
                    r => r.HasOne<Permiso>().WithMany()
                        .HasForeignKey("Idpermiso")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__PermisosB__IDPer__07C12930"),
                    l => l.HasOne<Employee>().WithMany()
                        .HasPrincipalKey("Email")
                        .HasForeignKey("Email")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__PermisosB__Email__06CD04F7"),
                    j =>
                    {
                        j.HasKey("Email", "Idpermiso").HasName("PK_Permisos_By_Usuario");
                        j.ToTable("PermisosByUsuario");
                        j.IndexerProperty<string>("Email").HasMaxLength(255);
        ...
        {
            entity.HasKey(e => e.Idpermiso).HasName("PK__Permiso__F11D75F37D265044");
